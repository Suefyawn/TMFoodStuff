          ...
          {[
            ...
            <button
              ...
              className={`text-xs font-bold px-3 py-1.5 rounded-lg border transition-colors ${
                filterStatus === opt.v ? 'bg-green-900/40 border-green-600 text-green-200' : 'bg-gray-800 border-gray-700 text-gray-400 hover:bg-gray-700'
              }`}
            >
              {opt.label}
            </button>
                  ...
                  <div className="flex items-start justify-between gap-3 flex-wrap">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        {r.verified_purchase && (
                          <span className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-green-300 bg-green-900/30 border border-green-700/50 rounded px-1.5 py-0.5">
                        ...
                        {draftDirty && (
                          <div className="flex gap-2 mt-1.5">
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 bg-green-600 hover:bg-green-500 text-white text-xs font-bold px-3 py-1.5 rounded-lg disabled:opacity-60"
                            >

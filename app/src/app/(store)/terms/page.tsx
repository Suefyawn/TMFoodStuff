...
export const metadata: Metadata = {
  ...
  description:
    'Terms of service for ordering from TMFoodStuff — payment, delivery, cancellations, refunds, and quality guarantee.',
...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-20">
      <h1 className="text-4xl font-playfair font-bold text-stone-900 mb-8">Terms &amp; Conditions</h1>
      <div className="space-y-6 text-stone-600 leading-relaxed">
        <p>Last updated: March 2025</p>
        <section>
          <h2 className="text-xl font-bold text-stone-900 mb-3">Orders &amp; Payment</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-stone-900 mb-3">Returns &amp; Refunds</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-stone-900 mb-3">Governing Law</h2>

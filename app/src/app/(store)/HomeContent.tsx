    ...
    <main className="scroll-mt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 grid grid-cols-2 md:grid-cols-4 gap-3">
          {trustItems.map(item => (
            <div key={item.text} className="flex items-center justify-center gap-2 md:gap-2.5 py-2">
              ...
              <div>
                <div className="text-xs md:text-sm font-semibold text-stone-800">{item.text}</div>
                <div className="text-xs text-stone-400 hidden sm:block">{item.sub}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="bg-gray-950 text-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-stone-400 mb-10 md:mb-14 max-w-xl mx-auto text-base md:text-lg">
            {lang === 'ar'
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-6">
            {whyUs.map(item => (
              <div key={item.title} className="bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 text-left hover:bg-white/10 transition-colors">
                ...
                <p className="text-stone-400 leading-relaxed text-sm md:text-base">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-20 text-center">
        ...
        <p className="text-stone-500 mb-6 md:mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-2 md:gap-3">
          {deliveryCities.map(city => (
            <span
              key={city}
              className="bg-stone-100 text-stone-800 px-4 md:px-5 py-2 md:py-2.5 rounded-full font-semibold text-sm hover:bg-green-100 hover:text-forest-dark transition-colors cursor-default"
            >
              {city}
            </span>
          ))}

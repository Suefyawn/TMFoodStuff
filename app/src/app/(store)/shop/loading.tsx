    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="bg-white border-b border-stone-100 px-4 py-8">
        <div className="max-w-7xl mx-auto">
          <div className="h-10 bg-stone-200 rounded-xl w-48 mb-2 animate-pulse" />
          <div className="h-5 bg-stone-100 rounded-xl w-72 animate-pulse" />
        </div>
      </div>
      ...
      <div className="bg-white border-b border-stone-100 px-4 py-3">
        <div className="max-w-7xl mx-auto">
          <div className="flex gap-3 mb-3">
            <div className="h-10 bg-stone-200 rounded-full w-64 animate-pulse" />
            <div className="h-10 bg-stone-200 rounded-full w-36 animate-pulse" />
          </div>
          <div className="flex gap-2 overflow-hidden">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="h-9 bg-stone-200 rounded-full w-24 flex-shrink-0 animate-pulse" />
            ))}
          </div>
        </div>
      </div>
          ...
          {[...Array(15)].map((_, i) => (
            <div key={i} className="bg-white rounded-3xl overflow-hidden border border-stone-100 shadow-sm">
              ...
              <div className="p-4 space-y-2">
                ...
                <div className="h-9 bg-stone-200 rounded-xl w-full animate-pulse" />
              </div>
            </div>
          ))}
        </div>

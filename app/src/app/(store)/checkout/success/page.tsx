...
export default async function CheckoutSuccessPage({
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-20 text-center" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      {order && <p className="text-green-700 font-black text-2xl mb-3 font-mono">#{order}</p>}
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <Link
          ...
          className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold px-6 py-3 rounded-xl transition-colors shadow-sm"
        >

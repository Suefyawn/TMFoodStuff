  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group flex flex-col">
      <Link href={`/product/${product.slug}`} className="block">
        <div className="relative aspect-square bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden flex items-center justify-center">
          ...
          <div className="absolute top-2 left-2 flex flex-col gap-1">
            ...
            {!inStock && (
              <span className="bg-gray-700 text-white text-xs font-black px-2 py-0.5 rounded-full">
                Out of Stock
              </span>
            )}
          </div>
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        {product.origin && (
          <p className="text-xs text-gray-400 mb-3">🌍 {product.origin}</p>
        )}
        <div className="mt-auto">
          <div className="text-xl font-black text-green-700 mb-3">
